...
export const INITIAL_PROJECTS = [
  ...
  { id: "32", code: "NOXH-SXD-09", name: "Nhà ở xã hội tại dự án Khu nhà ở 11A, xã Bình Hưng, huyện Bình Chánh (quỹ đất 20%)", investor: "Công ty TNHH MTV Đầu tư Kinh doanh nhà Khang Phúc", location: "Xã Tân Kiên, TP.HCM", totalArea: 1.33, height: 25, apartmentCount: 860, progress: 20, status: "Delayed", currentStep: "Thô đến tầng 10", parentStep: "Thực hiện dự án", childStep: "Thi công phần thân", stepDeadline: "2025-10-15", delayDays: 45, currentAgency: "Sở Xây dựng", currentDepartment: "Thanh tra Sở", deadline: "2027-12-31", stage: "THỰC HIỆN ĐẦU TƯ", isKeyProject: false, isPublicInvestment: false },
