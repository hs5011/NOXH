...
export const INITIAL_PROJECTS = [
  { 
    ...
    progress: 15, 
    status: "On Track", 
    currentStep: "Chấp thuận chủ trương đầu tư / lựa chọn chủ đầu tư", 
    parentStep: "Chấp thuận chủ trương đầu tư đồng thời giao chủ đầu tư", 
    childStep: "Chấp thuận chủ trương đầu tư / lựa chọn chủ đầu tư", 
  ...
  { 
    ...
    progress: 60, 
    status: "Warning", 
    currentStep: "Thẩm định báo cáo nghiên cứu khả thi", 
    parentStep: "Thẩm định báo cáo nghiên cứu khả thi", 
  ...
  { 
    ...
    progress: 30, 
    status: "Delayed", 
    currentStep: "Lấy ý kiến các sở ngành", 
  ...
  { id: "24", code: "NOXH-SXD-01", name: "Khu dân cư Phường Long Trường, thành phố Thủ Đức", investor: "Công ty TNHH Xây dựng and Kinh doanh nhà Điền Phúc Thành", location: "Phường Hiệp Phú, TP.HCM", totalArea: 1.43, height: 6, apartmentCount: 558, progress: 100, status: "On Track", currentStep: "Hoàn thành", currentAgency: "Sở Xây dựng", currentDepartment: "Phòng Quản lý nhà và Công sở", deadline: "2026-12-31", stage: "Hoàn thành", isKeyProject: false, isPublicInvestment: false },
  ...
  { id: "32", code: "NOXH-SXD-09", name: "Nhà ở xã hội tại dự án Khu nhà ở 11A, xã Bình Hưng, huyện Bình Chánh (quỹ đất 20%)", investor: "Công ty TNHH MTV Đầu tư Kinh doanh nhà Khang Phúc", location: "Xã Tân Kiên, TP.HCM", totalArea: 1.33, height: 25, apartmentCount: 860, progress: 20, status: "On Track", currentStep: "Thô đến tầng 10", currentAgency: "Sở Xây dựng", currentDepartment: "Thanh tra Sở", deadline: "2027-12-31", stage: "Thực hiện đầu tư", isKeyProject: false, isPublicInvestment: false },
  ...
  { id: "42", code: "NOXH-P3-07", name: "Nhà ở xã hội tại khu dân cư Đa Phước, huyện Bình Chánh", investor: "Công ty Cổ phần Đầu tư Kinh doanh Nhà", location: "Xã Đa Phước, TP.HCM", totalArea: 1.60, height: 15, apartmentCount: 650, progress: 10, status: "On Track", currentStep: "Móng", currentAgency: "Sở Xây dựng", currentDepartment: "Thanh tra Sở", deadline: "2029-12-31", stage: "Thực hiện đầu tư", isKeyProject: false, isPublicInvestment: false },
  { id: "43", code: "NOXH-P3-08", name: "Nhà ở xã hội tại khu dân cư Hưng Long, huyện Bình Chánh", investor: "Công ty Cổ phần Đầu tư Kinh doanh Nhà", location: "Xã Hưng Long, TP.HCM", totalArea: 1.40, height: 12, apartmentCount: 550, progress: 5, status: "On Track", currentStep: "Móng", currentAgency: "Sở Xây dựng", currentDepartment: "Thanh tra Sở", deadline: "2030-06-30", stage: "Thực hiện đầu tư", isKeyProject: false, isPublicInvestment: false },
  ...
  { id: "52", code: "NOXH-P3-17", name: "Nhà ở xã hội tại khu dân cư Tân Túc, huyện Bình Chánh", investor: "Công ty Cổ phần Đầu tư Kinh doanh Nhà", location: "Xã Tân Túc, TP.HCM", totalArea: 1.50, height: 15, apartmentCount: 550, progress: 10, status: "On Track", currentStep: "Móng", currentAgency: "Sở Xây dựng", deadline: "2033-06-30", stage: "Thực hiện đầu tư", isKeyProject: false, isPublicInvestment: false },
  { id: "53", code: "NOXH-P3-18", name: "Nhà ở xã hội tại khu dân cư Bình Hưng, huyện Bình Chánh", investor: "Công ty Cổ phần Đầu tư Kinh doanh Nhà", location: "Xã Bình Hưng, TP.HCM", totalArea: 1.40, height: 15, apartmentCount: 500, progress: 10, status: "On Track", currentStep: "Móng", currentAgency: "Sở Xây dựng", deadline: "2033-12-31", stage: "Kết thúc đầu tư", isKeyProject: false, isPublicInvestment: false },
  { id: "54", code: "NOXH-P3-19", name: "Nhà ở xã hội tại khu dân cư Phong Phú 2, huyện Bình Chánh", investor: "Công ty Cổ phần Đầu tư Kinh doanh Nhà", location: "Xã Phong Phú, TP.HCM", totalArea: 1.30, height: 12, apartmentCount: 450, progress: 5, status: "On Track", currentStep: "Móng", currentAgency: "Sở Xây dựng", deadline: "2033-12-31", stage: "Kết thúc đầu tư", isKeyProject: false, isPublicInvestment: false },
  { id: "55", code: "NOXH-P3-20", name: "Nhà ở xã hội tại khu dân cư Đa Phước 2, huyện Bình Chánh", investor: "Công ty Cổ phần Đầu tư Kinh doanh Nhà", location: "Xã Đa Phước, TP.HCM", totalArea: 1.20, height: 12, apartmentCount: 400, progress: 5, status: "On Track", currentStep: "Móng", currentAgency: "Sở Xây dựng", deadline: "2034-06-30", stage: "Kết thúc đầu tư", isKeyProject: false, isPublicInvestment: false },
  { id: "56", code: "NOXH-P3-21", name: "Nhà ở xã hội tại khu dân cư Hưng Long 2, huyện Bình Chánh", investor: "Công ty Cổ phần Đầu tư Kinh doanh Nhà", location: "Xã Hưng Long, TP.HCM", totalArea: 1.10, height: 12, apartmentCount: 350, progress: 5, status: "On Track", currentStep: "Móng", currentAgency: "Sở Xây dựng", deadline: "2034-12-31", stage: "Kết thúc đầu tư", isKeyProject: false, isPublicInvestment: false },
  { id: "57", code: "NOXH-P3-22", name: "Nhà ở xã hội tại khu dân cư Quy Đức 2, huyện Bình Chánh", investor: "Công ty Cổ phần Đầu tư Kinh doanh Nhà", location: "Xã Quy Đức, TP.HCM", totalArea: 1.00, height: 12, apartmentCount: 300, progress: 5, status: "On Track", currentStep: "Móng", currentAgency: "Sở Xây dựng", deadline: "2035-06-30", stage: "Kết thúc đầu tư", isKeyProject: false, isPublicInvestment: false },
];
...
export const INITIAL_PROJECT_STAGES = ['CHUẨN BỊ ĐẦU TƯ', 'THỰC HIỆN DỰ ÁN', 'KẾT THÚC DỰ ÁN', 'HOÀN THÀNH'];
...
export const INITIAL_AGENCIES = [
  ...
  { id: '3', name: 'Sở Nông nghiệp Môi trường', departments: ['Phòng Quy hoạch - Kế hoạch sử dụng đất', 'Phòng Kinh tế đất', 'Chi cục Quản lý đất đai'] },
  { id: '4', name: 'Sở Tài chính', departments: ['Phòng Đăng ký kinh doanh', 'Phòng Đầu tư', 'Phòng Đấu thầu, Thẩm định và Giám sát đầu tư'] },
  { id: '5', name: '168 Phường xã', departments: ['Phường An Lạc', 'Phường Hiệp Phú', 'Xã Hiệp Phước', 'Phường Long Trường', 'Phường Tân Thuận Tây', 'Xã Tân Kiên'] },
  { id: '6', name: 'UBND TP', departments: ['Văn phòng UBND TP', 'Phòng Nội chính', 'Phòng Kinh tế'] },
  { id: '7', name: 'HĐND TP', departments: ['Ban Kinh tế - Ngân sách', 'Ban Đô thị', 'Ban Pháp chế'] },
  { id: '8', name: 'Công an TP (PCCC)', departments: ['Phòng Cảnh sát PCCC & CNCH', 'Đội Thẩm duyệt'] }
