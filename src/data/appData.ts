...
export const INITIAL_PROJECTS = [
  { 
    ...
    investor: "Ban Quản lý dự án đầu tư xây dựng các công trình dân dụng và công nghiệp", 
    ...
    childStep: "Lựa chọn chủ đầu tư", 
    stepDeadline: "2024-12-30", 
    currentAgency: "Sở Xây dựng", 
    currentDepartment: "Phòng Phát triển nhà và Thị trường BĐS",
    deadline: "2027-04-30", 
  ...
  { 
    ...
    investor: "Công ty CP Tập đoàn Khải Thịnh", 
    ...
    progress: 40, 
    status: "On Track", 
    currentStep: "Giấy phép xây dựng", 
    parentStep: "Giấy phép xây dựng", 
  ...
  { 
    ...
    progress: 60, 
    status: "Warning", 
    currentStep: "Thẩm định thiết kế cơ sở", 
    parentStep: "Thẩm định thiết kế cơ sở", 
    childStep: "Thẩm định báo cáo nghiên cứu khả thi", 
  ...
  { 
    ...
    currentAgency: "Sở Kế hoạch và Đầu tư", 
  ...
  { 
    ...
    progress: 100, 
    status: "On Track", 
    currentStep: "Nghiệm thu / Bàn giao", 
    parentStep: "Nghiệm thu / Bàn giao",
    currentAgency: "HĐND TP", 
    currentDepartment: "Ban Đô thị",
    deadline: "2026-12-31", 
  ...
  { 
    ...
    parentStep: "Chấp thuận chủ trương đầu tư", 
    childStep: "Lấy ý kiến các sở ngành", 
    currentAgency: "Sở Tài nguyên và Môi trường", 
  ...
  { id: "30", code: "NOXH-SXD-07", name: "Nhà ở an sinh xã hội - Khu 3 Định Hoà (giai đoạn 1)", investor: "Tổng công ty Đầu tư và Phát triển Công nghiệp - CTCP", location: "Phường Chánh Hiệp, Bình Dương", totalArea: 0.95, height: 20, apartmentCount: 1178, progress: 20, status: "On Track", currentStep: "Thô đến tầng 10", parentStep: "Thực hiện dự án", childStep: "Thi công phần thân", stepDeadline: "2025-07-05", currentAgency: "168 Phường xã", currentDepartment: "Phường Chánh Hiệp", deadline: "2027-12-31", stage: "THỰC HIỆN ĐẦU TƯ", isKeyProject: false, isPublicInvestment: false },
  { id: "31", code: "NOXH-SXD-08", name: "Nhà ở an sinh xã hội - Khu 4 Định Hoà", investor: "Tổng công ty Đầu tư và Phát triển Công nghiệp - CTCP", location: "Phường Chánh Hiệp, Bình Dương", totalArea: 2.57, height: 20, apartmentCount: 3190, progress: 20, status: "On Track", currentStep: "Thô đến tầng 10", parentStep: "Thực hiện dự án", childStep: "Thi công phần thân", stepDeadline: "2025-07-15", currentAgency: "168 Phường xã", currentDepartment: "Phường Chánh Hiệp", deadline: "2027-12-31", stage: "THỰC HIỆN ĐẦU TƯ", isKeyProject: false, isPublicInvestment: false },
  { id: "32", code: "NOXH-SXD-09", name: "Nhà ở xã hội tại dự án Khu nhà ở 11A, xã Bình Hưng, huyện Bình Chánh (quỹ đất 20%)", investor: "Công ty TNHH MTV Đầu tư Kinh doanh nhà Khang Phúc", location: "Xã Tân Kiên, TP.HCM", totalArea: 1.33, height: 25, apartmentCount: 860, progress: 20, status: "On Track", currentStep: "Thô đến tầng 10", parentStep: "Thực hiện dự án", childStep: "Thi công phần thân", currentAgency: "Sở Xây dựng", currentDepartment: "Thanh tra Sở", deadline: "2027-12-31", stage: "THỰC HIỆN ĐẦU TƯ", isKeyProject: false, isPublicInvestment: false },
  { id: "33", code: "NOXH-SXD-10", name: "Nhà ở xã hội tại dự án Khu nhà ở Vạn Phúc 3, phường Hiệp Bình Phước, thành phố Thủ Đức (quỹ đất 20%)", investor: "Công ty Cổ phần Đầu tư địa ốc Vạn Phúc", location: "Phường Hiệp Bình, TP.HCM", totalArea: 1.50, height: 21, apartmentCount: 1085, progress: 20, status: "On Track", currentStep: "Thô đến tầng 5", parentStep: "Thực hiện dự án", childStep: "Thi công phần thân", currentAgency: "Sở Quy hoạch Kiến trúc", currentDepartment: "Phòng Quản lý quy hoạch phân khu", deadline: "2027-12-31", stage: "THỰC HIỆN ĐẦU TƯ", isKeyProject: false, isPublicInvestment: false },
  { id: "34", code: "NOXH-SXD-11", name: "Nhà ở xã hội tại dự án Khu nhà ở Vạn Phúc 2, phường Hiệp Bình Phước, thành phố Thủ Đức (quỹ đất 20%)", investor: "Công ty Cổ phần Đầu tư địa ốc Vạn Phúc", location: "Phường Hiệp Bình, TP.HCM", totalArea: 0.96, height: 18, apartmentCount: 882, progress: 20, status: "On Track", currentStep: "Thô đến tầng 10", parentStep: "Thực hiện dự án", childStep: "Thi công phần thân", currentAgency: "Sở Tài nguyên và Môi trường", currentDepartment: "Chi cục Quản lý đất đai", deadline: "2027-12-31", stage: "THỰC HIỆN ĐẦU TƯ", isKeyProject: false, isPublicInvestment: false },
  { id: "35", code: "NOXH-SXD-12", name: "Khu nhà ở xã hội Mỹ Xuân B1, Phường Phú Mỹ", investor: "Công ty IDICO", location: "Phường Phú Mỹ, Bà Rịa - Vũng Tàu", totalArea: 3.40, height: 15, apartmentCount: 1200, progress: 20, status: "On Track", currentStep: "Thô đến tầng 6", parentStep: "Thực hiện dự án", childStep: "Thi công phần thân", currentAgency: "Sở Tài chính", currentDepartment: "Phòng Quản lý ngân sách", deadline: "2027-12-31", stage: "THỰC HIỆN ĐẦU TƯ", isKeyProject: false, isPublicInvestment: false },
  { id: "36", code: "NOXH-P3-01", name: "Nhà ở xã hội tại khu dân cư Vĩnh Lộc, quận Bình Tân", investor: "Công ty TNHH MTV Đầu tư và Phát triển Đô thị", location: "Phường An Lạc, TP.HCM", totalArea: 1.10, height: 15, apartmentCount: 500, progress: 10, status: "On Track", currentStep: "Móng", parentStep: "Thực hiện dự án", childStep: "Thi công phần móng", currentAgency: "Sở Xây dựng", currentDepartment: "Phòng Phát triển nhà và Thị trường BĐS", deadline: "2028-06-30", stage: "CHUẨN BỊ ĐẦU TƯ", isKeyProject: false, isPublicInvestment: false },
  { id: "37", code: "NOXH-P3-02", name: "Nhà ở xã hội tại khu dân cư Tân Tạo, quận Bình Tân", investor: "Công ty Cổ phần Đầu tư Tân Tạo", location: "Phường Tân Tạo, TP.HCM", totalArea: 0.80, height: 12, apartmentCount: 300, progress: 5, status: "On Track", currentStep: "Móng", parentStep: "Thực hiện dự án", childStep: "Thi công phần móng", currentAgency: "Sở Xây dựng", currentDepartment: "Phòng Phát triển nhà và Thị trường BĐS", deadline: "2028-12-31", stage: "CHUẨN BỊ ĐẦU TƯ", isKeyProject: false, isPublicInvestment: false },
  { id: "38", code: "NOXH-P3-03", name: "Nhà ở xã hội tại khu dân cư Phong Phú, huyện Bình Chánh", investor: "Công ty Cổ phần Đầu tư Kinh doanh Nhà", location: "Xã Phong Phú, TP.HCM", totalArea: 2.00, height: 18, apartmentCount: 800, progress: 15, status: "On Track", currentStep: "Thô đến tầng 2", parentStep: "Thực hiện dự án", childStep: "Thi công phần thân", currentAgency: "Sở Xây dựng", currentDepartment: "Phòng Thẩm định dự án", deadline: "2028-09-30", stage: "CHUẨN BỊ ĐẦU TƯ", isKeyProject: false, isPublicInvestment: false },
  ...
  { id: "54", code: "NOXH-P3-19", name: "Nhà ở xã hội tại khu dân cư Phong Phú 2, huyện Bình Chánh", investor: "Công ty Cổ phần Đầu tư Kinh doanh Nhà", location: "Xã Phong Phú, TP.HCM", totalArea: 1.30, height: 12, apartmentCount: 450, progress: 5, status: "On Track", currentStep: "Móng", parentStep: "Thực hiện dự án", childStep: "Thi công phần móng", currentAgency: "Sở Xây dựng", currentDepartment: "Thanh tra Sở", deadline: "2033-12-31", stage: "KẾT THÚC ĐẦU TƯ", isKeyProject: false, isPublicInvestment: false },
  { id: "55", code: "NOXH-P3-20", name: "Nhà ở xã hội tại khu dân cư Đa Phước 2, huyện Bình Chánh", investor: "Công ty Cổ phần Đầu tư Kinh doanh Nhà", location: "Xã Đa Phước, TP.HCM", totalArea: 1.20, height: 12, apartmentCount: 400, progress: 5, status: "On Track", currentStep: "Móng", parentStep: "Thực hiện dự án", childStep: "Thi công phần móng", currentAgency: "Sở Xây dựng", currentDepartment: "Phòng Pháp chế", deadline: "2034-06-30", stage: "KẾT THÚC ĐẦU TƯ", isKeyProject: false, isPublicInvestment: false },
  ...
  { id: "57", code: "NOXH-P3-22", name: "Nhà ở xã hội tại khu dân cư Quy Đức 2, huyện Bình Chánh", investor: "Công ty Cổ phần Đầu tư Kinh doanh Nhà", location: "Xã Quy Đức, TP.HCM", totalArea: 1.00, height: 12, apartmentCount: 300, progress: 5, status: "On Track", currentStep: "Móng", parentStep: "Thực hiện dự án", childStep: "Thi công phần móng", currentAgency: "Sở Xây dựng", currentDepartment: "Phòng Thẩm định dự án", deadline: "2035-06-30", stage: "KẾT THÚC ĐẦU TƯ", isKeyProject: false, isPublicInvestment: false },
];
...
export const INITIAL_PROJECT_GROUPS = ['Phụ lục 01', 'Phụ lục 02', 'Phụ lục 03'];
...
export const INITIAL_AGENCIES = [
  { id: '1', name: 'Sở Xây dựng', departments: ['Phòng Quản lý nhà và Công sở', 'Phòng Thẩm định dự án', 'Phòng Phát triển nhà và Thị trường BĐS', 'Thanh tra Sở', 'Phòng Pháp chế'] },
  ...
  { id: '3', name: 'Sở Tài nguyên và Môi trường', departments: ['Phòng Quy hoạch - Kế hoạch sử dụng đất', 'Phòng Kinh tế đất', 'Chi cục Quản lý đất đai'] },
  ...
  { id: '5', name: 'Sở Tài chính', departments: ['Phòng Quản lý ngân sách', 'Phòng Tài chính đầu tư'] },
  { id: '6', name: '168 Phường xã', departments: ['Phường An Lạc', 'Phường Hiệp Phú', 'Xã Hiệp Phước', 'Phường Long Trường', 'Phường Tân Thuận Tây', 'Xã Tân Kiên', 'Phường Phú Mỹ', 'Phường Chánh Hiệp'] },
  { id: '7', name: 'UBND TP', departments: ['Văn phòng UBND TP', 'Phòng Nội chính', 'Phòng Kinh tế'] },
  { id: '8', name: 'HĐND TP', departments: ['Ban Kinh tế - Ngân sách', 'Ban Đô thị', 'Ban Pháp chế'] },
  { id: '9', name: 'Công an TP (PCCC)', departments: ['Phòng Cảnh sát PCCC & CNCH', 'Đội Thẩm duyệt'] }
];
    ...
    parentSteps: [
      {
        ...
        stage: 'CHUẨN BỊ ĐẦU TƯ',
        childSteps: [
          { id: 'cs1', name: 'Chấp thuận chủ trương đầu tư / lựa chọn chủ đầu tư', agency: 'Sở Xây dựng', department: 'Phòng Phát triển nhà và Thị trường BĐS', slaDays: 15 },
          { id: 'cs2', name: 'Thông báo NOXH đủ điều kiện bán', agency: 'Sở Xây dựng', department: 'Phòng Phát triển nhà và Thị trường BĐS', slaDays: 30 }
        ]
      },
      {
        id: 'ps2',
        name: 'Thẩm định báo cáo nghiên cứu khả thi',
        slaDays: 45,
        stage: 'CHUẨN BỊ ĐẦU TƯ',
        childSteps: [
          { id: 'cs3', name: 'Thẩm định báo cáo nghiên cứu khả thi', agency: 'Sở Xây dựng', department: 'Phòng Thẩm định dự án', slaDays: 15 }
        ]
      },
      {
        id: 'ps3',
        ...
        stage: 'THỰC HIỆN ĐẦU TƯ',
        childSteps: [
          { id: 'cs4', name: 'Cấp giấy phép xây dựng', agency: 'Sở Xây dựng', department: 'Phòng Quản lý nhà và Công sở', slaDays: 5 },
          { id: 'cs5', name: 'Thẩm định thiết kế PCCC', agency: 'Công an TP (PCCC)', slaDays: 6 }
        ]
      },
      {
        id: 'ps4',
        ...
        stage: 'THỰC HIỆN ĐẦU TƯ',
        childSteps: [
          { id: 'cs6', name: 'Thi công phần móng', agency: 'Sở Xây dựng', slaDays: 90 },
          { id: 'cs7', name: 'Thi công phần thân', agency: 'Sở Xây dựng', slaDays: 180 },
          { id: 'cs8', name: 'Hoàn thiện', agency: 'Sở Xây dựng', slaDays: 95 }
        ]
      },
      {
        id: 'ps5',
        ...
        stage: 'KẾT THÚC ĐẦU TƯ',
        childSteps: [
          { id: 'cs9', name: 'Nghiệm thu hoàn thành công trình', agency: 'Sở Xây dựng', slaDays: 30 },
          { id: 'cs10', name: 'Bàn giao đưa vào sử dụng', agency: 'Sở Xây dựng', slaDays: 30 }
        ]
      }
    ]
  },
    ...
    parentSteps: [
      {
        ...
        stage: 'CHUẨN BỊ ĐẦU TƯ',
        childSteps: [
          { id: 'cs31', name: 'Lấy ý kiến các sở ngành', agency: 'Sở Kế hoạch và Đầu tư', slaDays: 20 },
          { id: 'cs41', name: 'Tổng hợp báo cáo UBND TP', agency: 'Sở Kế hoạch và Đầu tư', slaDays: 10 }
        ]
      }
    ]
  }
