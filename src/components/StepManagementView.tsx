      ...
      <div className="p-8 max-w-7xl mx-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-lg text-slate-500 font-medium">Quản lý các thủ tục và bước con của quy trình</p>
          </div>
          <button 
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm">
              ...
              >
                <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                  <h3 className="text-2xl font-black text-slate-900">{editingParent?.parent ? 'Sửa thủ tục' : 'Thêm thủ tục'}</h3>
                ...
                <div className="p-8 space-y-6">
                  <div className="space-y-2">
                    <label className="text-sm font-black text-slate-400 uppercase tracking-widest">Tên thủ tục</label>
                    <input 
                      type="text" 
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <div className="flex flex-col">
                <span className="text-sm text-slate-400 font-black uppercase tracking-wider">Thủ tục</span>
